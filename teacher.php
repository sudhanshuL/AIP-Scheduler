...
if(isset($_POST['teacherLogin'])){
  ...
  $adminPassword = mysqli_real_escape_string($db, $_POST['adminPassword']); 
     echo 'dasdasdadsads';
    $res=mysqli_query($db,"select * from teachers where name='$adminUsername'");
        ...
        <div class="center-align form-align">
          ...
          <div class="row">
            <form action="" method="POST" autocomplete="off" class="col s12">
              ...
              <button type="submit" name="teacherLogin" class="waves-effect waves-light btn">Continue</button>
            </form>
